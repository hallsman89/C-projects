...
void shove_and_check_int(va_list *ss_arguments, scanfopt *sconfig, stack *tail, s21_size_t value);
void shove_and_check_uint(va_list *ss_arguments, scanfopt *sconfig, stack *tail, s21_size_t value);
void shove_and_check_float(va_list *ss_arguments, scanfopt *sconfig, stack *tail, char * buffer);
void shove_and_check_int_for_i(va_list *ss_arguments, scanfopt *sconfig, stack *tail, s21_size_t kostyl);
