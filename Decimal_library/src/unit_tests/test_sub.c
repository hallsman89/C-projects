...
START_TEST(test_1) {
  ...
  s21_decimal res = {0};
  int return_val = s21_sub(val_1, val_2, &res);
...
START_TEST(test_329) {
  ...
  char string[DEC_STR_LEN + 1] = {0};
  s21_from_decimal_to_string(res, string);
  char cmp[] = "281474976710652.1852502328934";
  ck_assert_int_eq(return_val, 0);
  ck_assert_str_eq(string, cmp);
}
END_TEST
...
START_TEST(test_330) {
  ...
  char string[DEC_STR_LEN + 1] = {0};
  s21_from_decimal_to_string(res, string);
  char cmp[] = "281474976710657.8147497671066";
  ck_assert_int_eq(return_val, 0);
  ck_assert_str_eq(string, cmp);
}
END_TEST
...
START_TEST(test_465) {
  ...
  char string[DEC_STR_LEN + 1] = {0};
  s21_from_decimal_to_string(res, string);
  char cmp[] = "-79228162514264309446046279270";
  ck_assert_int_eq(return_val, 0);
  ck_assert_str_eq(string, cmp);
}
END_TEST
...
START_TEST(test_473) {
  ...
  char string[DEC_STR_LEN + 1] = {0};
  s21_from_decimal_to_string(res, string);
  char cmp[] = "-764134127471577.8759354395034";
  ck_assert_int_eq(return_val, 0);
  ck_assert_str_eq(string, cmp);
}
END_TEST
