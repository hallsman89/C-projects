...
START_TEST(test_1) {
  ...
  s21_decimal res = {0};
  int return_val = s21_mul(val_1, val_2, &res);
...
START_TEST(test_321) {
  ...
  char string[DEC_STR_LEN + 1] = {0};
  s21_from_decimal_to_string(res, string);
  char cmp[] = "79228162514263774643590529020";
  ck_assert_int_eq(return_val, 0);
  ck_assert_str_eq(string, cmp);
}
END_TEST
...
START_TEST(test_325) {
  ...
  char string[DEC_STR_LEN + 1] = {0};
  s21_from_decimal_to_string(res, string);
  char cmp[] = "7922816251426377464359052902";
  ck_assert_int_eq(return_val, 0);
  ck_assert_str_eq(string, cmp);
}
END_TEST
...
START_TEST(test_329) {
  ...
  char string[DEC_STR_LEN + 1] = {0};
  s21_from_decimal_to_string(res, string);
  char cmp[] = "792281625142637.7464359052902";
  ck_assert_int_eq(return_val, 0);
  ck_assert_str_eq(string, cmp);
}
END_TEST
...
START_TEST(test_333) {
  ...
  char string[DEC_STR_LEN + 1] = {0};
  s21_from_decimal_to_string(res, string);
  char cmp[] = "7.922816251426377464359052902";
  ck_assert_int_eq(return_val, 0);
  ck_assert_str_eq(string, cmp);
}
END_TEST
...
START_TEST(test_341) {
  ...
  char string[DEC_STR_LEN + 1] = {0};
  s21_from_decimal_to_string(res, string);
  char cmp[] = "792281625142637746435905290.2";
  ck_assert_int_eq(return_val, 0);
  ck_assert_str_eq(string, cmp);
}
END_TEST
...
START_TEST(test_345) {
  ...
  char string[DEC_STR_LEN + 1] = {0};
  s21_from_decimal_to_string(res, string);
  char cmp[] = "79228162514263.77464359052902";
  ck_assert_int_eq(return_val, 0);
  ck_assert_str_eq(string, cmp);
}
END_TEST
...
START_TEST(test_349) {
  ...
  char string[DEC_STR_LEN + 1] = {0};
  s21_from_decimal_to_string(res, string);
  char cmp[] = "0.7922816251426377464359052902";
  ck_assert_int_eq(return_val, 0);
  ck_assert_str_eq(string, cmp);
}
END_TEST
...
START_TEST(test_365) {
  ...
  char string[DEC_STR_LEN + 1] = {0};
  s21_from_decimal_to_string(res, string);
  char cmp[] = "0.00000000000007922816251426377464359052902";
  ck_assert_int_eq(return_val, 0);
  ck_assert_str_eq(string, cmp);
}
END_TEST
...
START_TEST(test_381) {
  ...
  char string[DEC_STR_LEN + 1] = {0};
  s21_from_decimal_to_string(res, string);
  char cmp[] = "0.0000000000000000000000000007922816251426377464359052902";
  ck_assert_int_eq(return_val, 0);
  ck_assert_str_eq(string, cmp);
}
END_TEST
...
START_TEST(test_413) {
  ...
  char string[DEC_STR_LEN + 1] = {0};
  s21_from_decimal_to_string(res, string);
  char cmp[] = "0.00000000000000281474976710655";
  ck_assert_int_eq(return_val, 0);
  ck_assert_str_eq(string, cmp);
}
END_TEST
...
START_TEST(test_429) {
  ...
  char string[DEC_STR_LEN + 1] = {0};
  s21_from_decimal_to_string(res, string);
  char cmp[] = "0.000000000000000000000000000281474976710655";
  ck_assert_int_eq(return_val, 0);
  ck_assert_str_eq(string, cmp);
}
END_TEST
...
START_TEST(test_451) {
  s21_decimal val_1 = {{0xFFFFFFFF, 0x0000FFFF, 0x00000000, 0 << 16 | 1 << 31}};
  s21_decimal val_2 = {
      {0xFFFFFFFF, 0xFFFFFFFF, 0xFFFFFFFF, 0x0 << 16 | 0 << 31}};
  s21_decimal res = {0};
  int return_val = s21_mul(val_1, val_2, &res);
  ck_assert_int_eq(return_val, 2);
}
...
START_TEST(test_455) {
  s21_decimal val_1 = {{0xFFFFFFFF, 0x0000FFFF, 0x00000000, 0 << 16 | 1 << 31}};
  s21_decimal val_2 = {
      {0xFFFFFFFF, 0xFFFFFFFF, 0xFFFFFFFF, 0x1 << 16 | 0 << 31}};
  s21_decimal res = {0};
  int return_val = s21_mul(val_1, val_2, &res);
  ck_assert_int_eq(return_val, 2);
}
...
START_TEST(test_459) {
  s21_decimal val_1 = {{0xFFFFFFFF, 0x0000FFFF, 0x00000000, 0 << 16 | 1 << 31}};
  s21_decimal val_2 = {
      {0xFFFFFFFF, 0xFFFFFFFF, 0xFFFFFFFF, 0x14 << 16 | 0 << 31}};
  s21_decimal res = {0};
  int return_val = s21_mul(val_1, val_2, &res);
  ck_assert_int_eq(return_val, 2);
}
...
START_TEST(test_461) {
  ...
  char string[DEC_STR_LEN + 1] = {0};
  s21_from_decimal_to_string(res, string);
  char cmp[] = "2230074519853054.391337320401";
  ck_assert_int_eq(return_val, 0);
  ck_assert_str_eq(string, cmp);
}
END_TEST
...
START_TEST(test_473) {
  ...
  char string[DEC_STR_LEN + 1] = {0};
  s21_from_decimal_to_string(res, string);
  char cmp[] = "22300745198530543913373204010";
  ck_assert_int_eq(return_val, 0);
  ck_assert_str_eq(string, cmp);
}
END_TEST
...
START_TEST(test_477) {
  ...
  char string[DEC_STR_LEN + 1] = {0};
  s21_from_decimal_to_string(res, string);
  char cmp[] = "223007451985305.4391337320401";
  ck_assert_int_eq(return_val, 0);
  ck_assert_str_eq(string, cmp);
}
END_TEST
...
START_TEST(test_493) {
  ...
  char string[DEC_STR_LEN + 1] = {0};
  s21_from_decimal_to_string(res, string);
  char cmp[] = "22.30074519853054391337320401";
  ck_assert_int_eq(return_val, 0);
  ck_assert_str_eq(string, cmp);
}
END_TEST
...
START_TEST(test_509) {
  ...
  char string[DEC_STR_LEN + 1] = {0};
  s21_from_decimal_to_string(res, string);
  char cmp[] = "0.0000000000002230074519853054391337320401";
  ck_assert_int_eq(return_val, 0);
  ck_assert_str_eq(string, cmp);
}
END_TEST
...
START_TEST(test_709) {
  ...
  char string[DEC_STR_LEN + 1] = {0};
  s21_from_decimal_to_string(res, string);
  char cmp[] = "7922816251426433759354395034";
  ck_assert_int_eq(return_val, 0);
  ck_assert_str_eq(string, cmp);
}
END_TEST
...
START_TEST(test_713) {
  ...
  char string[DEC_STR_LEN + 1] = {0};
  s21_from_decimal_to_string(res, string);
  char cmp[] = "792281625142643.3759354395034";
  ck_assert_int_eq(return_val, 0);
  ck_assert_str_eq(string, cmp);
}
END_TEST
...
START_TEST(test_717) {
  ...
  char string[DEC_STR_LEN + 1] = {0};
  s21_from_decimal_to_string(res, string);
  char cmp[] = "7.922816251426433759354395034";
  ck_assert_int_eq(return_val, 0);
  ck_assert_str_eq(string, cmp);
}
END_TEST
...
START_TEST(test_725) {
  ...
  char string[DEC_STR_LEN + 1] = {0};
  s21_from_decimal_to_string(res, string);
  char cmp[] = "792281625142643375935439503.4";
  ck_assert_int_eq(return_val, 0);
  ck_assert_str_eq(string, cmp);
}
END_TEST
...
START_TEST(test_729) {
  ...
  char string[DEC_STR_LEN + 1] = {0};
  s21_from_decimal_to_string(res, string);
  char cmp[] = "79228162514264.33759354395034";
  ck_assert_int_eq(return_val, 0);
  ck_assert_str_eq(string, cmp);
}
END_TEST
...
START_TEST(test_733) {
  ...
  char string[DEC_STR_LEN + 1] = {0};
  s21_from_decimal_to_string(res, string);
  char cmp[] = "0.7922816251426433759354395034";
  ck_assert_int_eq(return_val, 0);
  ck_assert_str_eq(string, cmp);
}
END_TEST
...
START_TEST(test_749) {
  ...
  char string[DEC_STR_LEN + 1] = {0};
  s21_from_decimal_to_string(res, string);
  char cmp[] = "0.00000000000007922816251426433759354395034";
  ck_assert_int_eq(return_val, 0);
  ck_assert_str_eq(string, cmp);
}
END_TEST
...
START_TEST(test_765) {
  ...
  char string[DEC_STR_LEN + 1] = {0};
  s21_from_decimal_to_string(res, string);
  char cmp[] = "0.0000000000000000000000000007922816251426433759354395034";
  ck_assert_int_eq(return_val, 0);
  ck_assert_str_eq(string, cmp);
}
END_TEST
...
START_TEST(test_835) {
  s21_decimal val_1 = {{0xFFFFFFFF, 0xFFFFFFFF, 0xFFFFFFFF, 0 << 16 | 1 << 31}};
  s21_decimal val_2 = {
      {0xFFFFFFFF, 0x0000FFFF, 0x00000000, 0x0 << 16 | 0 << 31}};
  s21_decimal res = {0};
  int return_val = s21_mul(val_1, val_2, &res);
  ck_assert_int_eq(return_val, 2);
}
...
START_TEST(test_839) {
  s21_decimal val_1 = {{0xFFFFFFFF, 0xFFFFFFFF, 0xFFFFFFFF, 0 << 16 | 1 << 31}};
  s21_decimal val_2 = {
      {0xFFFFFFFF, 0x0000FFFF, 0x00000000, 0x1 << 16 | 0 << 31}};
  s21_decimal res = {0};
  int return_val = s21_mul(val_1, val_2, &res);
  ck_assert_int_eq(return_val, 2);
}
...
START_TEST(test_975) {
  s21_decimal val_1 = {{0xFFFFFFFF, 0xFFFFFFFF, 0xFFFFFFFF, 0 << 16 | 1 << 31}};
  s21_decimal val_2 = {
      {0xFFFFFFFF, 0xFFFFFFFF, 0xFFFFFFFF, 0x28 << 16 | 0 << 31}};
  s21_decimal res = {0};
  int return_val = s21_mul(val_1, val_2, &res);
  ck_assert_int_eq(return_val, 2);
}
...
START_TEST(test_989) {
  ...
  char string[DEC_STR_LEN + 1] = {0};
  s21_from_decimal_to_string(res, string);
  char cmp[] = "62771017353866807638357894240";
  ck_assert_int_eq(return_val, 0);
  ck_assert_str_eq(string, cmp);
}
END_TEST
...
START_TEST(test_1005) {
  ...
  char string[DEC_STR_LEN + 1] = {0};
  s21_from_decimal_to_string(res, string);
  char cmp[] = "6277101735386680.763835789424";
  ck_assert_int_eq(return_val, 0);
  ck_assert_str_eq(string, cmp);
}
END_TEST
...
START_TEST(test_1021) {
  ...
  char string[DEC_STR_LEN + 1] = {0};
  s21_from_decimal_to_string(res, string);
  char cmp[] = "62.77101735386680763835789424";
  ck_assert_int_eq(return_val, 0);
  ck_assert_str_eq(string, cmp);
}
END_TEST
